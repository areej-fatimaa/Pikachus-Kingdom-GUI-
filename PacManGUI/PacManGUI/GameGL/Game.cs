   ...
   public class Game
    {
        ...
        {
            GameObject blankGameObject = new GameObject(GameObjectType.REWARD, PacManGUI.Properties.Resources.pallet_removebg_preview);
            return blankGameObject;
        }
        ...
        public static Image getGameObjectImage(char displayCharacter)
        {
            ...
            if (displayCharacter == '.' || displayCharacter == ':')
            {
                img = PacManGUI.Properties.Resources.pallet_removebg_preview;
            }
            if (displayCharacter == 'P' || displayCharacter == 'p') 
            {
                img = PacManGUI.Properties.Resources.pika_removebg_preview__4_;
            }
            if (displayCharacter == 'D' || displayCharacter == 'D')
            {
                img = PacManGUI.Properties.Resources.Darco_removebg_preview;
            }
            if (displayCharacter == 'M' || displayCharacter == 'M')
            {
                img = PacManGUI.Properties.Resources.Misty_removebg_preview;
            }
