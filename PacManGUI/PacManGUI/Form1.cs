...
namespace PacManGUI
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            darko = new HorizontalGhost(darkoImage, startHorizontal, speed, pacman);
            misty = new VerticalGhost(mistyImage, startVertical, speed, pacman);
            spiko = new SmartGhost(spikoImage, startSmart, speed, pacman);
          Ghost.Add(darko);
            Ghost.Add(misty);
            // ghost.Add(spiko);
        ...
        {
            Bullet dBullet;
            dBullet = new Bullet(PacManGUI.Properties.Resources.bullet_removebg_preview, new GameCell(darko.CurrentCell.X, darko.CurrentCell.Y, darko.CurrentCell.Grid), darko);
